...
void initEngine() {
  ...
  const int OFFSET_DYNAMIC_MEMORY = OFFSET_CURRENT_COLOR + SIZE_CURRENT_COLOR;
  // const int OFFSET_DYNAMIC_MEMORY = align(OFFSET_CURRENT_COLOR + SIZE_CURRENT_COLOR, 65536);
